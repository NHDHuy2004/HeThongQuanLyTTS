...
function Header({ date, subtitle = 'Ghi nhận thời gian làm việc trong ngày.' }: { date: string; subtitle?: string }) {
  return <div><p className="text-sm font-medium text-teal-600">{date}</p><h1 className="text-2xl font-semibold tracking-tight">Điểm danh</h1><p className="mt-1 text-sm text-slate-500">{subtitle}</p></div>
}
